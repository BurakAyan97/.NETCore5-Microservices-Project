...
namespace FreeCourse.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            return status > 0 ? Response<NoContent>.Success(204)
        ...
        {
            var saveStatus = await _dbConnection.ExecuteAsync("INSERT INTO discount (userid,rate,code) VALUES  (@UserId,@Rate,@Code)", discount);//discount içinden valuesleri kendi map edip algılayıp işi hallediyor.
