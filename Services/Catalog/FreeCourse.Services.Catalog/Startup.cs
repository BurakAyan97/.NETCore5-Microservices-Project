    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(opt =>
            {
                ...
                opt.Audience = "resource_catalog";//Kİm alıyor
            ...
            {
                opt.Filters.Add(new AuthorizeFilter());//Tüm controllerlara authorize yapıldı.
            });

            services.Configure<DatabaseSettings>(Configuration.GetSection("DatabaseSettings"));

            services.AddSingleton<IDatabaseSettings, DatabaseSettings>(sp =>
            {//GetRequiredService bulamazsa hata fırlatır.Kesin bulmasını istediğimizde kullanırız.
